...
const comboItens = [
  { nome: "Tu Mente en GPT", etiqueta: "Guía 1", destino: "#tu-mente-en-gpt", desc: "Crea tu propio GPT personalizado con tu identidad, contexto y objetivos, sin programación." },
  { nome: "Tu Segundo Cerebro", etiqueta: "Guía 2", destino: "#tu-segundo-cerebro", desc: "Comandos premium para organizar ideas, evaluar posibilidades y decidir con mayor claridad." },
  { nome: "Tu Gemelo Digital", etiqueta: "Guía 3", destino: "#tu-gemelo-digital", desc: "Crea un avatar con tu imagen y tu voz para transformar tus ideas en videos." },
  { nome: "El Espejo Digital", etiqueta: "Bono", destino: "#el-espejo-digital", desc: "Descubre patrones, fortalezas y posibilidades que quizá todavía no habías visto." },
];
...
export function TuGemeloDigitalPage() {
  return <main className="upsell-font overflow-hidden bg-upsell-bg text-upsell-text selection:bg-upsell-blue selection:text-white">
    ...
    <ProdutoIndividual id="tu-mente-en-gpt" cover={tuMenteEnGPTCover} etiqueta="01 · BASE DEL MÉTODO" nome="Tu Mente en GPT" titulo="Deja de adaptar tu mente a la IA. Haz que la IA se adapte a ti." texto={<>Con un paso a paso sencillo, crearás tu propio GPT personalizado con tu identidad, experiencia, objetivos y forma de comunicarte. Al finalizar, tendrás un asistente configurado para ayudarte a escribir, planificar, analizar y desarrollar tus ideas con una base que ya es tuya, sin programación y sin volver a empezar de cero.</>} beneficios={["Tu identidad, tu voz y tus objetivos integrados en la IA","Contenido y respuestas mucho más alineados contigo","Ideas desarrolladas con dirección, profundidad y contexto","Tu propio asistente personalizado, listo para usar"]} icon={Brain} cta="QUIERO EL MÉTODO →" />
    <ProdutoIndividual id="tu-segundo-cerebro" cover={tuSegundoCerebroCover} etiqueta="02 · CONTINUIDAD DEL MÉTODO" nome="Tu Segundo Cerebro" titulo="Descubre posibilidades que nunca imaginaste antes." texto={<>Recibirás comandos premium listos para usar que te ayudarán a organizar lo que tienes en mente, explorar caminos que quizá no verías por tu cuenta, evaluar alternativas y convertir tus objetivos en planes concretos. Solo tienes que elegir el comando adecuado, adaptarlo a tu situación y dejar que la IA amplíe tu pensamiento como un verdadero segundo cerebro.</>} beneficios={beneficiosSegundo} light icon={Lightbulb} cta="QUIERO EL MÉTODO →" />
    <ProdutoIndividual id="tu-gemelo-digital" cover={tuGemeloDigitalCover} etiqueta="03 · PRESENCIA DIGITAL" nome="Tu Gemelo Digital" titulo="Grábate una vez. Haz que tu mensaje aparezca en video una y otra vez." texto={<>Aprenderás paso a paso a crear un avatar con tu imagen y tu voz para presentar tus ideas en video, aunque nunca hayas utilizado este tipo de tecnología. Así podrás transformar guiones en contenido, mantener tu presencia activa y comunicar mucho más, sin depender del tiempo, el escenario o la energía para grabarte cada vez.</>} beneficios={beneficiosGemelo} icon={Video} cta="QUIERO EL MÉTODO →" />
    <ProdutoIndividual id="el-espejo-digital" cover={elEspejoDigitalCover} etiqueta="04 · BONO ESPECIAL" nome="El Espejo Digital" titulo="Descubre lo que la IA ya ha percibido sobre ti y que quizá tú todavía no habías visto." texto={<>A través de una reflexión guiada, utilizarás tus propias conversaciones con la IA como un espejo. Descubrirás patrones de pensamiento, fortalezas naturales, motivaciones, valores y oportunidades que suelen pasar desapercibidos. Una experiencia reveladora para comprenderte desde otro ángulo y tomar decisiones con mayor claridad.</>} beneficios={["Identificar patrones invisibles en tu forma de pensar","Reconocer fortalezas que utilizas sin darte cuenta","Descubrir qué impulsa o frena tus decisiones","Encontrar nuevas posibilidades para actuar y evolucionar"]} light icon={Eye} cta="QUIERO EL MÉTODO →" />
    ...
    <section className="bg-upsell-light-alt px-5 py-12 sm:px-6 sm:py-14">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <div className="mt-7"><div className="upsell-eyebrow text-xs tracking-[0.22em] text-upsell-success uppercase">GARANTÍA DE 7 DÍAS</div><h2 className="mt-3 text-3xl font-bold text-upsell-light-text sm:text-4xl">Tu decisión está protegida durante 7 días.</h2><p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-upsell-light-muted sm:text-base">Accede al método, explora los materiales y comienza a aplicarlo con tranquilidad. Si dentro de los 7 días decides que no es para ti, podrás solicitar el reembolso según las condiciones de la plataforma de compra.</p></div>
