...
const comboItens = [
  { nome: "Tu Mente en GPT", etiqueta: "Guía 1", destino: "#tu-mente-en-gpt", desc: "Tu IA personalizada con tu contexto, tu identidad, tu voz y tus objetivos." },
  { nome: "Tu Segundo Cerebro", etiqueta: "Guía 2", destino: "#tu-segundo-cerebro", desc: "Comandos premium para organizar ideas, ampliar posibilidades y decidir con claridad." },
  { nome: "Tu Gemelo Digital", etiqueta: "Guía 3", destino: "#tu-gemelo-digital", desc: "Tu avatar con imagen y voz para crear videos sin grabarte cada vez." },
  { nome: "El Espejo Digital", etiqueta: "Bono", destino: "#el-espejo-digital", desc: "Nuevas perspectivas sobre tus patrones, fortalezas y forma de pensar." },
];
